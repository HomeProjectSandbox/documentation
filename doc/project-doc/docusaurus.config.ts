...
const config: Config = {
  ...
  url: 'https://HomeProjectSandbox.github.io',
  ...
  organizationName: 'HomeProjectSandbox.github.io', // Usually your GitHub org/user name.
  projectName: 'HomeProjectSandbox', // Usually your repo name.
  trailingSlash: false,
